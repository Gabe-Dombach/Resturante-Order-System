$(document).ready(function(){
    $('.loginBut').click(function(){
        console.log('working');
        if(localStorage.getItem($('.emailLogin').val())==null && $('.emailLogin').val() != 'admin'){
            window.alert("Account not found please check your credentials or register a new account");
        }
